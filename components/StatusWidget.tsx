        ...
        <div className="bg-white/90 backdrop-blur-md border border-slate-200 rounded-xl p-4 shadow-xl shadow-slate-200/50">
            ...
            <div className="space-y-5">
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                        <div className="flex justify-between text-xs mb-1.5">
                            ...
                            <span className="font-mono text-brand font-bold">{cpu.toFixed(0)}%</span>
                        </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                        <div className="flex justify-between text-xs mb-1.5">
                            ...
                            <span className="font-mono text-purple-600 font-bold">{ram.toFixed(0)}%</span>
                        </div>
                        <div className="h-1.5 w-full bg-slate-100 rounded-full overflow-hidden">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                        <div className="flex justify-between text-xs mb-1.5">
                            <span className="text-slate-600 font-medium">Ping</span>
                            <span className="font-mono text-emerald-600 font-bold">{net}ms</span>
                        </div>
                        <div className="flex gap-0.5 mt-1">
                            {[1,2,3,4,5].map(i => (
                                <div key={i} className={`h-1.5 flex-1 rounded-sm ${i <= 4 ? 'bg-emerald-500' : 'bg-slate-200'}`}></div>
                            ))}
                        </div>
                    </div>
                </div>
